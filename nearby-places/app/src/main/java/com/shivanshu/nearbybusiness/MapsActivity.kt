...
import com.shivanshu.nearbybusiness.databinding.ActivityMapsBinding
//import com.shivanshu.nearbybusiness.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
                    ...
                    if (response.isSuccessful) {
                        for (i in 0 until response.body()!!.results!!.size) {
                            ...
                            if (typePlace.equals("business")) {
                                markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.business))
                                    .title(placeName)
    ...
    private fun getUrl(latitude: Double, longitude: Double, typePlace: String): String {
        ...
        googlePlaceUrl.append("&key=AIzaSyDivyjc8o9_l1FGqhjmkMhu67sOdkOd6Mg")
    ...
    private fun buildLocationCallBack() {
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(p0: LocationResult) {
                mLastLocation = p0!!.locations.get(
                    p0
                    !!.locations.size - 1
                ) // Get last location
                if (mMarker != null) {
